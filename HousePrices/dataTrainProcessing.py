...
#进行对数变换
df_train['TotalBsmtSF'].loc[df_train['TotalBsmtSF'] == 0] = 0.001   #将0值替换为可log变换的另一个较小值
df_train['TotalBsmtSF']= np.log(df_train['TotalBsmtSF'])
# print(df_train['TotalBsmtSF'].head(50))
# print(df_train.isinf().sum().sort_values(ascending=False))
# print(np.isinf(df_train))
#绘制变换后的直方图和正态概率图
TmpTotalBsmtSF = df_train[df_train['TotalBsmtSF']>0.001]
...
df_train.to_csv('./data/handled/train_outlier_dummies.csv', index=False, encoding='utf-8')
# print(df_train.info())
# print(df_train.columns)
